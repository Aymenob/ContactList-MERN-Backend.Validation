...
function Home() {
  ...
  const Errors=useSelector(state=>state.Users.addedUser.errors)
  ...
  async function handleSubmit(e) {
    try {
      e.preventDefault();
      dispatch(addUser(contact)).then((e)=>e.payload.errors?setcontact(contact):setcontact({Email:"",Lastname:"",Firstname:"",Age:""}))
 ...
 useEffect(() => {
    Errors?alert(Errors.map(e=>e.msg+"\n")):console.log("all good")
    }
  , [Errors])
